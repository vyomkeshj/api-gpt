...
default_schema = """# Insurance_Data["months_as_customer","policy_state": [OH, NY, …], "age", "collision_type": [Side Collision, Rear Collision, Front Collision, Not Known], "policy_number", "incident_type", "policy_bind_date", "policy_csl", "policy_deductable", "policy_annual_premium", "umbrella_limit", "insured_zip", "insured_sex", "insured_education_level", "insured_occupation", "insured_hobbies", "insured_relationship", "capital_gains", "capital_loss", "incident_date", "incident_severity", "authorities_contacted": [Police, Fire, Other, None], "incident_state", "incident_city":  [Columbus, Riverwood, Arlington], "incident_location", "incident_hour_of_the_day":[1, 2, 3, ..., 24]: INTEGER, "number_of_vehicles_involved": INTEGER, "property_damage", "bodily_injuries", "witnesses", "police_report_available", "total_claim_amount", "injury_claim", "property_claim", "vehicle_claim", "auto_make": [Saab, Mercedes, Accura…], "auto_model":[E400, RAM, Tahoe], "auto_year", "fraud_reported": [Y, N]]"""
